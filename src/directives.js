...
angular.module('angular-popup-datepicker').provider('pickADate', pickADateProvider);
angular.module('angular-popup-datepicker').provider('pickATime', pickATimeProvider);
angular.module('angular-popup-datepicker', []).directive('pickADate', ['$parse', function() {    
    return {        
        restrict: 'A',
        require: '?ngModel',
        scope: {            
