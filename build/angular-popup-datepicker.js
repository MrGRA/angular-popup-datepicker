...
angular.module("angular-popup-datepicker",[]).directive("pickADate",function(){return{restrict:"A",scope:{pickADate:"=",pickADateOptions:"="},link:function(a,b,c){function d(c){if("function"==typeof h&&h.apply(this,arguments),!a.$$phase&&!a.$root.$$phase){var d=b.pickadate("picker").get("select");// selected date
d&&a.$apply(function(){return c.hasOwnProperty("clear")?void(a.pickADate=null):(a.pickADate&&"string"!=typeof a.pickADate||(a.pickADate=new Date(0)),a.pickADate.setYear(d.obj.getFullYear()),a.pickADate.setMonth(d.obj.getMonth()),void a.pickADate.setDate(d.obj.getDate()))})}}function e(a){b.pickadate("picker").set("select",b.val(),{format:g.format})}function f(a){"function"==typeof i&&i.apply(this,arguments)}var g=a.pickADateOptions||{},h=g.onSet,i=(g.onOpen,g.onClose);b.pickadate(angular.extend(g,{onOpen:e,onSet:d,onClose:f,container:document.body})),setTimeout(function(){a.pickADate&&b.pickadate("picker").set("select",a.pickADate)},1e3)}}}).directive("pickATime",function(){return{restrict:"A",scope:{pickATime:"=",pickATimeOptions:"="},link:function(a,b,c){function d(c){if("function"==typeof g&&g.apply(this,arguments),!a.$$phase&&!a.$root.$$phase){var d=b.pickatime("picker").get("select");// selected date
d&&a.$apply(function(){return c.hasOwnProperty("clear")?void(a.pickATime=null):(a.pickATime&&"string"!=typeof a.pickATime||(a.pickATime=new Date),a.pickATime.setHours(d.hour),a.pickATime.setMinutes(d.mins),a.pickATime.setSeconds(0),void a.pickATime.setMilliseconds(0))})}}function e(a){"function"==typeof h&&h.apply(this,arguments)}var f=a.pickATimeOptions||{},g=f.onSet,h=f.onClose;b.pickatime(angular.extend(f,{onSet:d,onClose:e,container:document.body})),setTimeout(function(){a.pickATime&&b.pickatime("picker").set("select",a.pickATime)},1e3)}}});